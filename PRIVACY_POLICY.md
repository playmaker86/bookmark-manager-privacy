# Privacy Policy for Bookmark Manager

**Last Updated:** October 2025

## Data Collection and Usage

Bookmark Manager is committed to protecting your privacy. This extension:

- ✅ **Does NOT collect any personal data**
- ✅ **Does NOT transmit any data to external servers**
- ✅ **Does NOT track user behavior**
- ✅ **Works entirely locally** - All processing happens in your browser

## What Data We Access

### Bookmarks Permission
- This extension requires access to your bookmarks to:
  - Scan for duplicate bookmarks
  - Display bookmark information
  - Remove duplicate bookmarks (only when you explicitly request it)
